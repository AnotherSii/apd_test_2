...
# how to make a better UI for this contract - web based
# how does the Web3 interact with the blockchain, but not through the chrome extension
# can store addresses for future distributions
...
@export
def amount_transfer(initial_amount: float, receivers: str, amounts: str)
    sender = ctx.caller # ctx.caller is the verified person who signed the transaction
    balance = State[sender]
